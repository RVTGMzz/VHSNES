...
def main() -> int:
    ap = argparse.ArgumentParser(description="Probe 008: Vietnamese font V2 real-menu phrase test")
    ap.add_argument("rom", type=Path)
    ap.add_argument("output", type=Path)
    here = Path(__file__).resolve().parent
    ap.add_argument("--codepage", type=Path, default=here.parent / "translation" / "codepage" / "vi_codepage_v2.csv")
    ap.add_argument("--glyphs", type=Path, default=here.parent / "translation" / "codepage" / "vi_glyphs_v2.json")
    ...
    print("expected_runtime_rows=Âm thanh / Bói!! / Đấu đội! / Vẽ!! / Maruko? / Ổn rồi")
