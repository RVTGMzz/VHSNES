...
def main() -> int:
    ap = argparse.ArgumentParser(description="Probe 011: FE4 Vietnamese native-width thin raster on Chibi menu")
    ...
    print("expected_runtime_rows=Âm thanh / Bói!! / Đấu đội! / Vẽ!! / Maruko? / Ổn rồi  # FE4 native-width thin glyph style")
